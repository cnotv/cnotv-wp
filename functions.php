...
$sage_includes = [
	...
	'src/filters.php',
	'src/admin.php',
	// 'src/customizer.php',										// Theme customizer
	'src/wp_bootstrap_navwalker.php',						// Bootstrap Nav Walker
	'src/theme_options.php',										// Theme options (Logo, etc..)
	'src/post_type-portfolio.php',									// CPT Portfolio
	'src/taxonomy-portfolio-category.php',									// Taxonomy subfields
	'src/taxonomy-subfields.php',									// Taxonomy subfields
	'src/taxonomy-tools.php',									// Taxonomy Tools
	'src/metabox-link.php',									// Metabox link
	'src/disable_comment.php',									// Disable comment
];
